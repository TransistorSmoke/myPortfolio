<?php
    ...
    if ($email === ''){
      ...
      print json_encode(array('message' => 'Sorry. Your email is format invalid.', 'code' => 0));
      exit();
      }
    }
    ...
    print json_encode(array('message' => 'Your message has been successfully sent. I will get back to you very soon. Thank you.', 'code' => 1));
    exit();
